...
--
-- Name: appointments appointments_service_id_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointments_service_id_key UNIQUE (service_id);
...
--
-- Name: appointments makeitunique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT makeitunique UNIQUE (customer_id);
